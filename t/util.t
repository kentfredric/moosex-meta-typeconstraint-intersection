...
my $intersection = intersection([@role_tcs]);
...
is(
    $intersection->name,
    intersection([reverse @role_tcs])->name,
    'order of type constraints does not matter',
);

ok($intersection->equals($intersection), 'is equal to itself');
ok($intersection->equals(intersection([@role_tcs])), 'is equal to clone');
ok($intersection->equals(intersection([reverse @role_tcs])), 'is equal to reversed clone');
